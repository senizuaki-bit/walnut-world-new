...
> INT2 当前事实（2026-08-15）：上一行只作 historical INT1 evidence。Agent 仍是 Library，不拥有产品 HTTP、数据库、Draft/Build/Activation/World 写口。当前 additive v0.6 candidate 为 148 entries、28,042-byte manifest、SHA-256 `bb4f1c12f34125bcc4b79b6a1330a20848a7f43764d87fa7c8d7668e7994fe14`；v0.4/v0.5 历史字节继续锁定，v0.6 tag 尚不存在。
>
