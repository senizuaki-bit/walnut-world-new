...
func _initialize() -> void:
	...
	if not server.start():
		push_error("Could not bind local Gateway E2E port 8790.")
		quit(1)
		return
	...
	app.runtime_environment_override = {"YAYA_API_BASE_URL": "http://127.0.0.1:8790", "YAYA_AUTH_TOKEN": "e2e-token"}
	...
	resumed.runtime_environment_override = {"YAYA_API_BASE_URL": "http://127.0.0.1:8790", "YAYA_AUTH_TOKEN": "e2e-token"}
