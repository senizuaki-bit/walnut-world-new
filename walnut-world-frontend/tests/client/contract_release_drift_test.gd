...
const EXPECTED_MANIFEST_SHA256 := "bb4f1c12f34125bcc4b79b6a1330a20848a7f43764d87fa7c8d7668e7994fe14"
const EXPECTED_MANIFEST_BYTES := 28042
const EXPECTED_MANIFEST_FILES := 148
